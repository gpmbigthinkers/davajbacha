import type { DashboardOverview, ScenarioTemplate } from "@/lib/demo-types";
...
export const footprintSignals = [
  {
    id: "school",
    label: "Názov školy v bio",
    risk: 18,
    derived: "Identifikácia školy a vekovej skupiny",
    safe: "Školu uvádzať len v neverejných kontextoch",
  },
  {
    id: "route",
    label: "Ranné story zo zastávky",
    risk: 22,
    derived: "Približná trasa a čas odchodu",
    safe: "Zverejňovať oneskorene bez presnej lokality",
  },
  {
    id: "family",
    label: "Fotky súrodencov a rodičov",
    risk: 17,
    derived: "Rodinné väzby a kontaktné body",
    safe: "Neoznačovať rodinu na verejnom profile",
  },
  {
    id: "hobby",
    label: "Pravidelný krúžok každý utorok",
    risk: 16,
    derived: "Predvídateľný týždenný režim",
    safe: "Zdieľať bez pravidelného času a miesta",
  },
  {
    id: "contact",
    label: "Telefón alebo súkromný mail",
    risk: 25,
    derived: "Priamy kanál na sociálne inžinierstvo",
    safe: "Použiť oddelený kontakt alebo žiadny verejný kontakt",
  },
];
